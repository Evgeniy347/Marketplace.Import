    ...
    public static class StringExtensions
    {
        ...
        public static string Crypt(this string text)
        {
            ...
            if (!String.IsNullOrEmpty(text))
            {
                ...
                byte[] outputBuffer = Crypt(inputbuffer);
        ...
        public static byte[] Crypt(this byte[] inputbuffer)
        {
            byte[] result = null;
        ...
        public static string Decrypt(this string text)
        {
            ...
            if (!String.IsNullOrEmpty(text))
            {
                ...
                byte[] outputBuffer = Decrypt(inputbuffer);
        ...
        public static byte[] Decrypt(this byte[] inputbuffer)
        {
            byte[] result = null;
